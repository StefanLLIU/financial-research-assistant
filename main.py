...
<style>
  ...
  .sidebar{width:240px;flex-shrink:0;background:#fff;border-radius:10px;padding:18px 16px;box-shadow:0 2px 8px rgba(0,0,0,.08);position:sticky;top:40px;}
  .sidebar h4{margin:0 0 10px;color:#1e3a5f;font-size:15px;border-bottom:1px solid #eef2f7;padding-bottom:6px;}
  .sidebar .cat{border-bottom:1px solid #f1f5f9;}
  .sidebar .cat>summary{cursor:pointer;list-style:none;padding:9px 4px;color:#1e3a5f;font-size:14px;font-weight:600;display:flex;align-items:center;justify-content:space-between;user-select:none;}
  .sidebar .cat>summary::-webkit-details-marker{display:none;}
  .sidebar .cat>summary::after{content:"▾";font-size:11px;color:#94a3b8;transition:transform .15s;}
  .sidebar .cat[open]>summary::after{transform:rotate(180deg);}
  .sidebar .cat>summary:hover{color:#2d5480;}
  .sidebar .cat-stocks{display:flex;flex-wrap:wrap;gap:6px;padding:2px 0 12px;}
  .sidebar a.tk{display:inline-block;background:#eff6ff;color:#1e3a5f;text-decoration:none;padding:4px 10px;border-radius:6px;font-size:13px;font-weight:600;transition:background .15s;}
  .sidebar a.tk:hover{background:#1e3a5f;color:#fff;}
  @media(max-width:860px){.layout{flex-direction:column;}.sidebar{width:auto;position:static;}}
  h1{color:#1e3a5f;}
  input{padding:10px 14px;font-size:16px;border:1px solid #d1d5db;border-radius:6px;width:200px;}
  button{padding:10px 20px;font-size:16px;background:#1e3a5f;color:#fff;border:none;border-radius:6px;cursor:pointer;margin-left:8px;}
  .card{margin-top:30px;background:#fff;border-radius:10px;padding:24px;box-shadow:0 2px 8px rgba(0,0,0,.08);}
  .metric{display:inline-block;background:#eff6ff;border-radius:6px;padding:6px 12px;margin:4px;font-size:14px;}
  h2{color:#1e3a5f;border-bottom:2px solid #eff6ff;padding-bottom:8px;}
  h3{color:#374151;}
  ...
  th,td{text-align:left;padding:11px 14px;border-bottom:1px solid #eef2f7;font-size:15px;}
  th{background:#f1f5f9;color:#334155;font-weight:600;width:40%;}
  td.up{color:#166534;font-weight:600;}
  td.down{color:#991b1b;font-weight:600;}
...
def root(lang: str = "zh"):
    return page("", lang=_norm_lang(lang))
